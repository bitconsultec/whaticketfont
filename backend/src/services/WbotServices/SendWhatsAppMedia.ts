import { WAMessage, AnyMessageContent, proto } from "@whiskeysockets/baileys";
  ...
  try {
    ...
    if (quotedMsgId) {
      ...
      if (chatMessages) {
        ...
        } else if (msgFound.message.audioMessage) {
          message = {
            audioMessage: msgFound.message.audioMessage,
          }
        }else if (msgFound.message.conversation) {
          message = {
            conversation: msgFound.message.conversation,
          }
        }else if (msgFound.message.imageMessage) {
          message = {
            imageMessage: msgFound.message.imageMessage,
          }
        }else if (msgFound.message.contactMessage) {
          message = {
            contactMessage: msgFound.message.contactMessage,
          }
        }else if (msgFound.message.documentMessage) {
          message = {
            documentMessage: msgFound.message.documentMessage,
          }
        }else if (msgFound.message.videoMessage) {
          message = {
            videoMessage: msgFound.message.videoMessage,
          }
        }else if (msgFound.message.locationMessage) {
          message = {
            locationMessage: msgFound.message.locationMessage,
          }
        }
