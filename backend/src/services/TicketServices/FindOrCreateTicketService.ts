...
const FindOrCreateTicketService = async (
  ...
  // console.log(lastMessage?.fromMe);

  // console.log(ticket.nextNotify);

   const fromMe = lastMessage?.fromMe || false;
  // console.log(new Date() >= ticket.nextNotify);

  // console.log(new Date() >= ticket.nextNotify && notification && !fromMe)
  if (((new Date() >= ticket.nextNotify)|| !ticket.nextNotify) && notification && !fromMe) {
