...
const UpdateUserService = async ({
  ...
  if (user.super && +userId !== requestUser.id) {
    throw new AppError("A senha só pode ser alterada pelo usuario super");
  }
  ...
  if (
    ...
    throw new AppError("O usuário de perfil user não poder editar outros usuarios");
  }
