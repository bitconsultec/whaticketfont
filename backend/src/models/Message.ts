...
class Message extends Model<Message> {
  ...
  @HasMany(() => Message, {
    foreignKey: "quotedMsgId", // Relacionamento baseado no quotedMsgId
    scope: { mediaType: "reactionMessage" }, // Filtro para mensagens do tipo "reactionMessage"
  })
  reactionsMsg: Message[];
