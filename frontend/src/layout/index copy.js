...
import { ChevronRight, RotateLeft } from "@material-ui/icons";
    ...
    <div className={classes.root}>
      <Drawer
        ...
        classes={{
          paper: clsx(
            ...
            isHorizontal && classes.hideSideBar
          ),
        }}
        open={drawerOpen}
      >
      ...
      <AppBar
        ...
        className={clsx(
          ...
          !isHorizontal && classes.hideTopBar
        )}
        color="primary"
      >
        <Toolbar variant="dense" className={classes.toolbar}>
          ...
          <Tooltip title="Menu vertical">
            <IconButton onClick={() => setIsHorizontal(false)}>
              <RotateLeft style={{ color: "white" }} />
            </IconButton>
          </Tooltip>
