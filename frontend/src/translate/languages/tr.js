const messages = {
  tr: {
    translations: {
      ...
      appBarListem: {
        newVersion: "Yeni sürüm mevcut! Güncellemek için burayı tıklayın",
        ticket: "Hizmet",
        notificationUser: "Bildirim kullanıcısı",
        quickResponse: "Hızlı yanıtlar",
        kanban: "Kanban",
        contacts: "Kişiler",
        schedule: "Programlar",
        tags: "Etiketler",
      ...
      mainDrawer: {
        listItems: {
          ...
          referral: "Referans",
          settings: "Ayarlar",
          notifyUser: "Kullanıcı Bildirimi",
        },
        appBar: {
          user: {
            profile: "Profil",
      ...
      initialConfig: {
        title: "İlk ayar",
        content1: "Equipechat 😊'a Hoşgeldiniz",
        content2:
          "Bunu kolaylaştırmak için * Hayatın, otomatik bir başlangıç ​​konfigürasyonu sağlıyoruz, böylece tüm Equipechat * * İnanılmaz * özelliklerini birkaç dakika içinde test edebilirsiniz.",
        content3:
        ...
        content4:
          "Bağlı sayıda ilk mesajı alır almaz, Equipechat eyleme geçecektir. 😎",
        content5:
      ...
      backendErrors: {
        ERR_INSUFFICIENT_QUOTA:
          "Yetersiz kota. Lütfen OpenAI'da planınızı ve faturalama ayrıntılarınızı kontrol edin.",
